...
class Client:
    ...
    def displayBackground(self, map):
        images = {
            "grass" :  pygame.image.load(os.path.join(self.texturesPath, 'grass.png')),
            "wall" : pygame.image.load(os.path.join(self.texturesPath, 'wall.png'))
        }
        x=0
        y=0
    ...
    def on_init(self):
        ...
        self.snake = Snake()        
        self.displayBackground(self.map)
